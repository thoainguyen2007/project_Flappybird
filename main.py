import numpy as np
import gym
from func import test, train,FlappyBirdCustom
import gym
import gym_ple
...
steps = train(q_values, episodes=50, epsilon_min=.001, epsilon_decay_rate=.99, env=env, max_steps=1000,gamma=1, alpha=.9)
history = test(q_values, 10,env)
